...
debug: build
	opam exec -- ocamldebug _build/default/camlcards/main.bc

DOCS_PATH=docs/
DOCS_NAME=camlcards
DOCS_DESCR=A card game engine
...
<meta content="https://github.com/CharlesAverill/camlcards" property="og:url" />
endef
...
docs: cleandocs build
	...
	mv $(DOCS_PATH)camlcards/camlcards.html $(DOCS_PATH)index.html
	mv $(DOCS_PATH)camlcards $(DOCS_PATH)module
